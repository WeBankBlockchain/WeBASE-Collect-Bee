...
import com.webank.webasebee.core.generated.db.method.entity.HelloWorldSet;
import com.webank.webasebee.core.generated.db.method.repository.HelloWorldSetMethodRepository;
...
public class HelloWorldSetMethodCrawlerImpl implements BcosMethodCrawlerInterface {
	...
	@Autowired
	private HelloWorldSetMethodRepository repository;
	...
	public void transactionHandler(Transaction transaction, BigInteger blockTimeStamp, Map.Entry<String, String> entry, String methodName) {
		...
		HelloWorldSet entity = new HelloWorldSet();

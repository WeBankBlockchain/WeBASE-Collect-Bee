...
import com.webank.webasebee.db.generated.entity.method.RuleRule;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface RuleRuleMethodRepository extends JpaRepository<RuleRule, Long>, JpaSpecificationExecutor<RuleRule>, RollbackInterface {
	RuleRule findByTxHash(String txHash);

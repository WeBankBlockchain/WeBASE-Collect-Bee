...
@Entity(name = "Member_setStatus")
@Table(name = "Member_setStatus", indexes = { @Index(name = "block_height", columnList = "block_height"),
        @Index(name = "block_timestamp", columnList = "block_timestamp"),
        @Index(name = "tx_hash", columnList = "tx_hash")})
@ToString(callSuper = true)
@EqualsAndHashCode(callSuper = true)
public class MemberSetStatus extends IdEntity {

...
import com.webank.webasebee.db.generated.entity.method.MemberMember;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface MemberMemberMethodRepository extends JpaRepository<MemberMember, Long>, JpaSpecificationExecutor<MemberMember>, RollbackInterface {
	MemberMember findByTxHash(String txHash);

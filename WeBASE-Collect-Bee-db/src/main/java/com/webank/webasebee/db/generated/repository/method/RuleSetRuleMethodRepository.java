...
import com.webank.webasebee.db.generated.entity.method.RuleSetRule;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface RuleSetRuleMethodRepository extends JpaRepository<RuleSetRule, Long>, JpaSpecificationExecutor<RuleSetRule>, RollbackInterface {
	RuleSetRule findByTxHash(String txHash);

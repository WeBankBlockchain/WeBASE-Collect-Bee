...
import com.webank.webasebee.db.generated.entity.event.RuleNewRuleEvent;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface RuleNewRuleEventRepository extends JpaRepository<RuleNewRuleEvent, Long>, JpaSpecificationExecutor<RuleNewRuleEvent>, RollbackInterface {
	public RuleNewRuleEvent findTopByOrderByBlockHeightDesc();

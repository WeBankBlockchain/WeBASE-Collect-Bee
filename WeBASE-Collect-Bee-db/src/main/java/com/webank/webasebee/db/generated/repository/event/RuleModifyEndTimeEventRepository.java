...
import com.webank.webasebee.db.generated.entity.event.RuleModifyEndTimeEvent;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface RuleModifyEndTimeEventRepository extends JpaRepository<RuleModifyEndTimeEvent, Long>, JpaSpecificationExecutor<RuleModifyEndTimeEvent>, RollbackInterface {
	public RuleModifyEndTimeEvent findTopByOrderByBlockHeightDesc();

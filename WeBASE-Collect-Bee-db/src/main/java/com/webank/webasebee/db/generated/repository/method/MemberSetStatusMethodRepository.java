...
import com.webank.webasebee.db.generated.entity.method.MemberSetStatus;
import com.webank.webasebee.db.repository.RollbackInterface;


@Repository
public interface MemberSetStatusMethodRepository extends JpaRepository<MemberSetStatus, Long>, JpaSpecificationExecutor<MemberSetStatus>, RollbackInterface {
	MemberSetStatus findByTxHash(String txHash);
